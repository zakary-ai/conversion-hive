...
const Email = ({ fullName, email, password, loginUrl }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your Conversion Lab admin account is ready</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={card}>
          <Heading style={heading}>Welcome{fullName ? `, ${fullName}` : ''}</Heading>
          <Text style={muted}>You've been granted admin access to Conversion Lab. Use the credentials below to sign in. You'll be prompted to set a new password on your first sign-in.</Text>
...
export const template = {
  component: Email,
  subject: 'Your Conversion Lab admin account is ready',
